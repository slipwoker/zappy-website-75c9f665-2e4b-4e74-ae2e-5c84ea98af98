(function() {
  ...
  function initContactForm() {
    ...
    form.addEventListener('submit', function(e) {
      ...
      .then(function() {
        var successMsg = form.querySelector('.form-success') || document.createElement('div');
      ...
      .catch(function() {
        var errorMsg = form.querySelector('.form-global-error') || document.createElement('div');
        if (!form.querySelector('.form-global-error')) {
      ...
      .finally(function() {
        if (submitBtn) {
          ...
          submitBtn.textContent = submitBtn.getAttribute('data-original') || 'Send';
        }
      });
    });

    var submitBtn = form.querySelector('button[type="submit"], input[type="submit"]');
    if (submitBtn && !submitBtn.getAttribute('data-original')) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '75c9f665-2e4b-4e74-ae2e-5c84ea98af98',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '75c9f665-2e4b-4e74-ae2e-5c84ea98af98';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 053-771-2488 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '75c9f665-2e4b-4e74-ae2e-5c84ea98af98';
